...
extern "C"
JNIEXPORT jintArray JNICALL Java_com_tianshaokai_opencv_OpenCVLearn_gray
...
extern "C"
JNIEXPORT jintArray JNICALL Java_com_tianshaokai_opencv_OpenCVLearn_blur
        (JNIEnv *env, jclass, jintArray buf, jint w, jint h) {
    jint *srcBuf = env->GetIntArrayElements(buf, JNI_FALSE);
    if(srcBuf == NULL) {
        return 0;
